        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              Specialized in cloud-native technologies, CI/CD pipelines, and SRE practices.
            </motion.p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Proven expertise across the modern DevOps stack
            </p>
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Let's discuss how I can help scale your infrastructure and improve your DevOps practices.
            </p>
